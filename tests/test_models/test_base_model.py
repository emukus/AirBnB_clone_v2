...
class test_basemodel(unittest.TestCase):
    ...
    def test_todict(self):
        ...
        mdl = self.value()
        mdl.firstname = 'Bostone'
        mdl.lastname = 'Ochieng'
        self.assertIn('firstname', mdl.to_dict())
        self.assertIn('lastname', mdl.to_dict())
        self.assertIn('firstname', self.value(firstname='Bostone').to_dict())
        self.assertIn('lastname', self.value(lastname='Ochieng').to_dict())
